...
def haniID():
  ...
  try:
    httpCaht = requests.get("https://pastebin.com/raw/2gGuEAJm").text
    if id in httpCaht:
      print('')
      print("\033[1;92m ✔️✔️...!")
      msg = str(os.geteuid())
...
print('''\x1b[38;5;140m
      ...
      𝑇𝑂𝑂𝐿𝑆 \x1b[1;38;5;121m 𓄌 \x1b[1;95m ⚜️ KO  \x1b[1;96mNAN⚜️         
...
print(J+'━'*40)
print('')
print(" \033[1;34m  ⚜️ KONAN ⚜️ @KO00NAN     ")
print()
print(J+'━'*40)
print()
...
g= datetime.datetime(2024, 12, 30, 0, 0 )


if (x.strftime("%x"))>(g.strftime("%x")):
 print('\033[1;32m تم ايقاف الاداه راسل كونان للاشتراك ')
 time.sleep(1)
 print('\033[1;31m راسل كونان للاشتراك @KO00NAN    ')
 time.sleep(1)
 print('\033[1;32m  ⚜️KONAN⚜️')
 time.sleep(1)
 print('\033[1;31m 1')
 time.sleep(1)
 print('\033[1;32m 2')
...
print('')
print(f''' \x1b[1;93m  ༺ \x1b[1;38;5;121m  KONAN VIP \x1b[1;93m ༻  ''')
print('')
...
def menu(my_name,my_id):
	...
	print('\n   \033[0m\033[1;93m [\033[1;93m\033[1;44m  𝗜𝗢𝗚i𝗡 i𝗡𝗙𝗢  :  والله حدثتها  هيج تصدك؟\033[0m\033[1;93m]\n')
	...
	print('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}\x1b[38;5;133m 𝑇𝐸l𝐸 \x1b[38;5;230m ⁞ \x1b[38;5;153m@KO00NAN')
	print('\x1b[38;5;230m')
	print('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m} \x1b[38;5;133m𝐂𝐇𝐀𝐍𝐍𝐄l \x1b[38;5;230m ⁞ \x1b[38;5;153m @hkeraldola   ')
	print('')
	print(g67+'━'*67)
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s ⚜️ KONAN ⚜️%s/%s » 🔹 𝐎𝐊  🧸 %s » 🧸 𝐶𝑃 🔹  %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
